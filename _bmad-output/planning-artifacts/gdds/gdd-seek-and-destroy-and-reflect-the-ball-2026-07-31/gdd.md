...
2026-08-12 : déplacé vers le PRD UX dédié — voir `_bmad-output/planning-artifacts/prds/prd-ux-seek-and-destroy-and-reflect-the-ball-2026-08-12.md`, section "Contrôles et input" (inputs par écran, bindings clavier/manette par joueur).
...
2026-08-12 : détaillé dans le PRD UX dédié — voir `_bmad-output/planning-artifacts/prds/prd-ux-seek-and-destroy-and-reflect-the-ball-2026-08-12.md`, section "Direction artistique et audio" (style pixel art, musique, table complète des prompts de portraits par personnage, prompt du fond d'écran de sélection, dimensions finales, workflow Gemini/GIMP). Repères conservés ici pour mémoire rapide :

- Style : pixel art, spectacle visuel riche, shmup épuré/lisible (ref. R-Type, Air Zonk) — pas de bullet-hell dense.
- Lisibilité d'état 100% diégétique (hors PV, qui a un HUD explicite) : usure du vaisseau + transparence d'icône + liseré doré à pleine charge.
- Musique : metal + touche électronique, composée en interne par Camil.
- Roster : direction "pixel art délire" façon Air Zonk/Bonk's Adventure, prompts Gemini assemblés par personnage (voir PRD UX pour le détail).
