...
|---|---|---|---|---|---|
| **Traqueur** (Missiles) | Femme | Cyan / orange | Missiles téléguidés à l'épaule | ✅ Image validée : `docs/Gemini_Generated_Image_onkan0onkan0onka.png` (génération v1, avant ce fix). Prompt v2 si régénération : *Wacky exaggerated cartoon pixel art video game character sprite, Air Zonk / Bonk's Adventure style — chibi proportions (oversized head, compact body), huge expressive eyes, big toothy grin, thick bold black outlines, saturated two-tone color scheme (armor + accent), hard pixel edges with cel-shaded highlights. A female hunter-type character with a comically oversized grin, huge determined cartoon eyes, exaggerated shoulder-mounted missile pods way bigger than realistic, bright orange and cyan color scheme, holding oversized binoculars with a mischievous "gotcha" expression. Isolated character sprite floating in empty space — absolutely no floor, no ground, no horizon line, no scenery, no shadow, no gradient. The entire background must be a single flat solid hot magenta color (#FF00FF), nothing else. No text/logo/watermark.* | *Wacky exaggerated cartoon pixel art video game character sprite, Air Zonk / Bonk's Adventure style — chibi proportions (oversized head, compact body), huge expressive eyes, big toothy grin, thick bold black outlines, saturated two-tone color scheme (armor + accent), hard pixel edges with cel-shaded highlights. Female hunter character, close bust portrait, huge mischievous grin, one shoulder-mounted missile pod visible over her shoulder in frame, cyan and orange armor, holding one small missile casually near her face like she's about to wink. Isolated character sprite floating in empty space — absolutely no floor, no ground, no horizon line, no scenery, no shadow, no gradient. The entire background must be a single flat solid hot magenta color (#FF00FF), nothing else. No text/logo/watermark.* |
